...
if regen:
    ...
    dataset_cycle = gen_random_circuits(min_gate=20, max_gate=300, n_circuits=150, two_qubit_gate_probs=[
        3, 7], gate_num_step=20, backend=backend, multi_process=True, circuit_type='cycle')
    dataset_cycle += gen_random_circuits(min_gate=300, max_gate=1200, n_circuits=50, two_qubit_gate_probs=[
        3, 7], gate_num_step=20, backend=backend, multi_process=True, circuit_type='cycle')
