...
for size, n_qubits in zip(size_list, qubit_list):
    ...
    dataset = gen_cut_dataset(n_qubits, topology, neighbor_info, coupling_map, dataset_size = 1000,min_cut_qubit=3,devide_size=5)

    test_dataset = gen_cut_dataset(n_qubits, topology, neighbor_info, coupling_map, dataset_size = 500,min_cut_qubit=3,devide_size=5)
    ...
    downstream_model.train(
        train_dataset, validation_dataset, epoch_num=50)
