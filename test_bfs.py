...
from upstream.randomwalk_model import travel_instructions, travel_instructions_BFS
...
for head_gate in circuit_info['gates']:
    ...
    traveled_paths_bfs = travel_instructions_BFS(circuit_info, head_gate, path_per_node, max_step, neighbor_info)
