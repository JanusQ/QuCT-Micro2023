...
class TestLinearToffoli(TestCase):
    ...
    def test_controlled_gate(self):
        ...
        state = qclib2.util.get_state(circuit)
        ...
        state = qclib2.util.get_state(circuit2)
    ...
    def test_linear_toffoli2(self):
        ...
        circuit2.x(3)
        circuit2.x(0)
        state1 = qclib2.util.get_state(circuit2)

        circuit = qiskit.QuantumCircuit(4)
        mc_gate(gate_x, circuit, [3, 2, 1], 0)

        circuit2.compose(circuit, circuit2.qubits)
        state2 = qclib2.util.get_state(circuit2)
    ...
    def test_linear_toffoli0(self):
        ...
        state2 = qclib2.util.get_state(circuit)
