...
import numpy as np
import qiskit
from qclib2.entanglement import geometric_entanglement, \
    meyer_wallach_entanglement
from qclib2.state_preparation.baa_schmidt import initialize
from qclib2.state_preparation.schmidt import cnot_count as schmidt_cnots
from qclib2.util import get_state
...
class TestBaa(TestCase):
    ...
    def test_node_state_vector(self):
        ...
        from qclib2.state_preparation.util import baa
