...
import numpy as np
from baseline.qfast import plugins
from baseline.qfast import utils
from baseline.qfast.gate import Gate
from baseline.qfast.topology import Topology
...
class Decomposer():
    ...
    def decompose(self):
        ...
        while any([gate.num_qubits > self.target_gate_size
            ...
            print('out_iteration time:', iteration_time)
        return gate_list
