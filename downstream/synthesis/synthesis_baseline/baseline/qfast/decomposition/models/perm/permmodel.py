...
import numpy as np
from baseline.qfast.decomposition.circuitmodel import CircuitModel
from baseline.qfast.decomposition.models.perm.fixedgate import FixedGate
from baseline.qfast.decomposition.models.perm.genericgate import GenericGate
...
class PermModel(CircuitModel):
    ...
    def solve(self):
        ...
        while True:
            ...
            print('inner_iteration time:', iteration_time)
        return self.finalize()
