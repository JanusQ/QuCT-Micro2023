...
class StateprepObjective(Objective):
    def gen_error_func(self, circuit, options):
        ...
        def generated_error_func(parameters):
            return comparison.distance_with_initial_state(target_state, initial_state, target,
    ...
    def gen_error_jac(self, circuit, options):
        ...
        def generated_error_jac(parameters):
            return comparison.distance_with_initial_state_jac(target_state, initial_state, target,
                                                              *circuit.mat_jac(parameters))
    ...
    def gen_error_residuals(self, circuit, options):
        ...
        def generated_error_residuals(parameters):
            return comparison.residuals_with_initial_state(target_state, initial_state, target,
                                                           circuit.matrix(parameters), I)
    ...
    def gen_error_residuals_jac(self, circuit, options):
        ...
        def generated_error_residuals_jac(parameters):
            return comparison.residuals_with_initial_state_jac(target_state, initial_state, target,
                                                               *circuit.mat_jac(parameters))
