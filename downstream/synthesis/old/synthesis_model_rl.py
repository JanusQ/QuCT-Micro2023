...
class SynthesisModel():
    ...
    def construct_model(self):
        ...
        self.critic_model = DNN((4**n_qubits, 2**n_qubits, 2**n_qubits, n_qubits), verbose = True, n_iter_no_change=10)
        self.critic_model.fit(Us, gate_vecs)

        output = self.critic_model.predict(Us[:10000])
