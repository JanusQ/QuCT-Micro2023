...
class SynthesisModel():
    ...
    @staticmethod
    def find_parmas(n_qubits, layer2gates, U, lr=1e-1, max_epoch=50, max_dist=1e-2):
    ...
    def synthesize(self, U):
        ...
        while now_dist > 5e-2:
            ...
            #         best_params = params
            # params = best_params
            params, dist =  self.find_parmas(n_qubits, total_layer2gates, U, max_epoch=50) # 有时候甚至会长，因为优化的问题
