...
paths = [
    ...
    'execute_18bits_validate_vjfarious_input_200_more_info.pkl'
]
dataset  = []
for path in paths:
...
# futures = []
# # for start in range(20, 4220,100):
# for start in range(20, dataset_size, 100):
...
test_dataset = dataset[:20] + dataset[4220:]
...
with open(f"execute_18bit_new/step1/error_params_predicts_execute_18bits_train_0_2500_step1.pkl","wb")as f:
...
axes.plot([[0,0],[1,1]])
fig.savefig(f"execute_18bit_new/step1/real_predictedy__step1_0.4.svg")  # step
