...
from downstream.synthesis.synthesis_model_nn import pkl_dump, pkl_load
from downstream.synthesis.synthesis_model_nn import SynthesisModel
...
'''生成用于测试的模板电路'''
model_name = f'q{n_qubits}_0220_NN'
# max_gate = 4**n_qubits
# min_gate = 5
...
circuits = gen_random_circuits(min_gate=500, max_gate=501, gate_num_step=1, n_circuits=1, two_qubit_gate_probs=[
                               3, 4], backend=backend, reverse=False, optimize=True, multi_process=True)[0]
